package cn.sppan.base.service.impl;

import cn.sppan.base.common.Constants;
import cn.sppan.base.dao.IResourceDao;
import cn.sppan.base.dao.support.IBaseDao;
import cn.sppan.base.entity.Resource;
import cn.sppan.base.entity.Role;
import cn.sppan.base.service.IResourceService;
import cn.sppan.base.service.IRoleService;
import cn.sppan.base.service.support.impl.BaseServiceImpl;
import cn.sppan.base.vo.ZtreeView;
...
public class ResourceServiceImpl extends BaseServiceImpl<Resource, Integer>
    ...
    @Override
    @Cacheable(value = Constants.RESOURCE_CACHE_NAME, key = "'tree_' + #roleId")
